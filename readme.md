...
atw s3赛季末wild bag点数转商店点数，spin up 20404配置修改，spin up 20421新增活动（未生效）

### 2021-01-07

atw s3赛季末wild bag点数转商店点数BUG修改
GOF 作弊功能实现

### 2021-01-08

[职业规划](https://www.jianshu.com/p/7af47a140dc2)
...
prize hunt添加word game判断
判断key是否在dict中，可以使用 key in dict
